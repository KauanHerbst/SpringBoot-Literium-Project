...
| <kbd>GET /users</kbd>     |  Recupera um Pageable com as informações dos usuários cadastrados [Request-Response](#get-users)
| <kbd>GET /users/{id}</kbd>     |  Recupera as informações do usuário de acordo com o ID passado no parâmetro [Request-Response](#get-users-id)
...
| <kbd>GET /books</kbd>     |  Recupera um Pageable com as informações dos livros cadastrados [Request-Response](#get-books)
| <kbd>GET /books/{id}</kbd>     |  Recupera as informações do livro de acordo com o ID passado no parâmetro [Request-Response](#get-books-id)
| <kbd>GET /books/{name}</kbd>     |  Recupera as informações do livro de acordo com o NAME passado no parâmetro [Request-Response](#get-books-name)
...
| <kbd>GET /category</kbd>     |  Recupera um Pageable com as informações das categorias cadastrados [Request-Response](#get-category)
| <kbd>GET /category/{id}</kbd>     |  Recupera as informações de uma categoria de acordo com o ID passado no parâmetro [Request-Response](#get-category-id)
| <kbd>GET /category/{id}/books</kbd>     |  Recupera um Pageable de livros de uma categoria de acordo com o ID passado no parâmetro [Request-Response](#get-books-category)
...
| <kbd>POST /favorites/{id_user}/{id_book}</kbd>     |  Recebe os ID do usuário e do livro para a criação de uma relação e retorna as informações salvas [Request-Response](#post-favorites)
| <kbd>GET /favorites/{id}</kbd>     |  Recupera um Pageable com as informações dos favoritos de acordo com o ID passado no parâmetro [Request-Response](#get-favorites)
...
| <kbd>POST /orders/{id_user}/{id_book}</kbd>     |  Recebe os ID do usuário e do livro para a criação de uma relação e retorna as informações salvas [Request-Response](#post-favorites)
| <kbd>GET /orders/{id}</kbd>     |  Recupera um Pageable com as informações dos pedidos de acordo com o ID passado no parâmetro [Request-Response](#get-favorites)
| <kbd>PUT /orders{id}</kbd>     |  Recebe os dados de uma pedido para atualização e retorna os dados já atualizados [Request-Response](#put-category)
